$(function() {
  ...
  $table.bootstrapTable({
    ...
    icons: {
      paginationSwitchDown: 'feather icon-chevron-down',
      paginationSwitchUp: 'feather icon-chevron-up',
      refresh: 'feather icon-refresh-ccw',
      columns: 'feather icon-grid',
      detailOpen: 'feather icon-plus',
      detailClose: 'feather icon-minus',
      export: 'feather icon-download-cloud'
    },
