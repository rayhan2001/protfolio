...
var colorPalette = ['#28D094', '#716aca', '#ff9149', '#FF4961', '#1e9ff2']
...
var options2 = {
    ...
    colors: ["#716aca", "#28D094", "#FF4961", "#1e9ff2"],
    xaxis: {
        tickAmount: 12,
        type: 'datetime',
...
var options = {
    ...
    colors: ["#716aca", "#8897AA", "#28D094", "#FF4961", "#e3eaef"],
    legend: {
        show: true,
        position: 'bottom',
...
var options = {
    ...
    labels: ["Series 1", "Series 2", "Series 3", "Series 4", "Series 5"],
    colors: ["#1e9ff2", "#ff9149", "#313a46", "#FF4961", "#28D094"],
    responsive: [{
        breakpoint: 600,
        options: {
            chart: {
...
var options = {
    ...
    colors: ['#28D094', '#716aca', '#FF4961', '#ff9149'],
    series: [76, 67, 61, 90],
...
var options = {
    ...
    fill: {
        ...
        gradient: {
            ...
            type: 'horizontal',
            shadeIntensity: 0.5,
            gradientToColors: ["#1e9ff2", "#716aca"],
            inverseColors: true,
            opacityFrom: 1,
            opacityTo: 1,
            stops: [0, 100]
...
var options = {
    ...
    colors: ["#1e9ff2", "#28D094", "#e3eaef", "#8897AA", "#ff9149"],
    grid: {
        borderColor: '#f1f3fa',
        xaxis: {
            showLines: true
