$(function() {
        ...
        'fa-draft2digital',
        'fa-dribbble', 'fa-dribbble-square', 'fa-dropbox', 'fa-drupal', 'fa-dyalog', 'fa-earlybirds', 'fa-ebay', 'fa-edge', 'fa-elementor', 'fa-ello', 'fa-ember', 'fa-Auric', 'fa-envira', 'fa-erlang', 'fa-ethereum', 'fa-etsy',
        'fa-expeditedssl',
        ...
        for (var i = 0, l = iconlist.length; i < l; i++) {
                $('#icons-container').append(
                    '<div class="i-block card" data-clipboard-text="fas ' + iconlist[i] + '" data-filter="' + iconlist[i] + '"  data-toggle="tooltip" title="' + iconlist[i] + '">' +
                    '<i class="fas ' + iconlist[i] + '"></i>' +
                    '</div>');
            }
            for (var i = 0, l = iconlistbrand.length; i < l; i++) {
                $('#icons-container').append(
                    '<div class="i-block card" data-clipboard-text="fab ' + iconlistbrand[i] + '" data-filter="' + iconlistbrand[i] + '"  data-toggle="tooltip" title="' + iconlistbrand[i] + '">' +
